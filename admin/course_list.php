    ...
    <div id="wrap">
        <div id="page-heading">
            <ol class="breadcrumb">
                ...
                <li class="active">View Course Information</li>
            </ol>
                    ...
                    <div class="panel panel-sky">
                        ...
                        <div class="panel-body collapse in">
                            <div id="example_wrapper" class="dataTables_wrapper" role="grid">
                                ...
                                <thead>
                                    <tr role="row">
                                        <th class="sorting" role="columnheader" tabindex="0" aria-controls="example" rowspan="1" colspan="1"  style="width: 265px;">Course Code</th>
                                        <th class="sorting" role="columnheader" tabindex="0" aria-controls="example" rowspan="1" colspan="1"  style="width: 229px;">Course Name</th>
                                        <th class="sorting" role="columnheader" tabindex="0" aria-controls="example" rowspan="1" colspan="1"  style="width: 151px;">Division</th>
                            ...
                            <tbody role="alert" aria-live="polite" aria-relevant="all">
                                <tr class="gradeA odd">
                                <td class=" ">ENG-01</td>
                                <td class=" ">English literature</td>
                                <td class=" ">VII</td>
