    ...
    <div id="wrap">
        <div id="page-heading">
            <ol class="breadcrumb">
                ...
                <li>Fee Category Managment</li>
                <li class="active">Manage Admission Fee Categories</li>
            </ol>

            <h1>Fee Category Managment</h1>
            <div class="options">
                <div class="btn-toolbar">
              ...
              <div class="col-md-12">
                    <div class="panel panel-sky">
                        <div class="panel-heading">
                            <h4>Admission Fee Category Details</h4>
                            <!--div class="options">   
                        ...
                        <div class="panel-body collapse in">
                            <div class="btn-primary btn" style="float:right" id="save" >Add Fee Category</div>
                            ...
                            <div id="example_wrapper" class="dataTables_wrapper" role="grid">
                                ...
                                <thead>
                                    <tr role="row">
                                        <th class="sorting" role="columnheader" tabindex="0" aria-controls="example" rowspan="1" colspan="1"  style="width: 265px;">Fee Name</th>
                                        <th class="sorting" role="columnheader" tabindex="0" aria-controls="example" rowspan="1" colspan="1"  style="width: 229px;">Amount</th>
