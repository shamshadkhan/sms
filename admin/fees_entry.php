...
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  ...
  <body class="" style="">
     ...
     <div class="slide-div" id="slide-div" style="display:none">
      <img src="image/circle-cross.png" width="25" height="25" class="close"/>
            <form action="" enctype="multipart/form-data" style="margin-top:15px;"method="post" class="form-horizontal" style="border-top-left-radius: 0px; border-top-right-radius: 0px; border-bottom-right-radius: 0px; border-bottom-left-radius: 0px;">
             <h3>Edit Fee Payment</h3>
           <hr>
            <div class="" style="border:none;">
              <div class="form-group">
                <label style="" class="col-sm-3 control-label">Fee Name</label>
                ...
                <div class="form-group">
                <label style="" class="col-sm-3 control-label">Amount</label>
                <div style="" class="col-sm-6">
    ...
    <div class="slide-div1" id="slide-div1" style="display:none">
      <img src="image/circle-cross.png" width="25" height="25" class="close"/>
            <form action="" enctype="multipart/form-data" style="margin-top:15px;"method="post" class="form-horizontal" style="border-top-left-radius: 0px; border-top-right-radius: 0px; border-bottom-right-radius: 0px; border-bottom-left-radius: 0px;">
             <h3>Full Fee Payment</h3>
           <hr>
            <div class="" style="border:none;">
              <div class="form-group">
                <label style="" class="col-sm-3 control-label">Fee Name</label>
                ...
                <label style="" class="col-sm-3 control-label">Amount</label>
                <div style="" class="col-sm-6">
                    <input type="text" name="emp_name" class="form-control" value="5000">
                </div>
              </div>
              <div class="panel-footer">
                <div class="row">
                    <div class="col-sm-6 col-sm-offset-3">
                        <div class="btn-toolbar">
                          <button class="btn-primary btn" type="submit" name="save" id="save1" >Save</button>
                          <button class="btn-default btn">Cancel</button>
                        </div>
                    </div>
                </div>
          ...
          <div id="wrap">
              <div id="page-heading">
                  <ol class="breadcrumb">
                      ...
                      <li class="active">Manage Student's fees</li>
                  </ol>
                    ...
                    <div class="panel-body collapse in">
                           <div class="form-group">
                            ...
                            <tbody role="alert" aria-live="polite" aria-relevant="all">
                                <tr class="gradeA odd">
                                <td class=" ">342</td>
                                <td class=" ">Faisal Khan</td>
                                <td class=" ">5000</td>
                                <td class=" ">100</td>
                                <td class=" ">4900</td>
                                <td class=" "><span class="action-icon"><a href="#" id="full">Full</a></span>|<span class="action-icon"><a href="#" id="partial">Partial</a></span></td>
                                </tr>
                                <tr class="gradeA odd">
                                <td class=" ">343</td>
                                ...
                                <td class=" ">5000</td>
                                <td class=" ">-</td>
                                <td class=" "><span class="action-icon">Paid</span>|<span class="action-icon"><a href="deletedemployee.php?id=' . $row_port['id'] . '">Edit</a></span></td>
                                </tr>
                              <?php
