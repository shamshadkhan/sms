     ...
     <div class="slide-div" id="slide-div" style="display:none">
      <img src="image/circle-cross.png" width="25" height="25" class="close"/>
            <form action="" enctype="multipart/form-data" style="margin-top:15px;"method="post" class="form-horizontal" style="border-top-left-radius: 0px; border-top-right-radius: 0px; border-bottom-right-radius: 0px; border-bottom-left-radius: 0px;">
             <h3>Employee Position Entry</h3>
           <hr>
            <div class="" style="border:none;">
              <div class="form-group">
                <label style="" class="col-sm-3 control-label">Name</label>
                <div style="" class="col-sm-6">
                    <input type="text" name="emp_name" class="form-control">
                </div>
              </div>
              <div class="form-group">
                  <label style="" class="col-sm-3 control-label">Category
                  </label>
                  <select class="form-control col-sm-3" style="width: 45%;margin-left: 10px;" name="emp_designation" id="source">
    ...
    <div id="wrap">
        <div id="page-heading">
            <ol class="breadcrumb">
                ...
                <li>Position Managment</li>
                <li class="active">Manage Employee Position</li>
            </ol>

            <h1>Position Managment</h1>
            <div class="options">
                <div class="btn-toolbar">
              ...
              <div class="col-md-12">
                    <div class="panel panel-sky">
                        <div class="panel-heading">
                            <h4>Employee Position Details</h4>
                            <!--div class="options">   
                        ...
                        <div class="panel-body collapse in">
                            <div class="btn-primary btn" style="float:right" id="save" >Add Position</div>
                            ...
                            <div id="example_wrapper" class="dataTables_wrapper" role="grid">
                                ...
                                <thead>
                                    <tr role="row">
                                        <th class="sorting" role="columnheader" tabindex="0" aria-controls="example" rowspan="1" colspan="1"  style="width: 265px;">Name</th>
                                        <th class="sorting" role="columnheader" tabindex="0" aria-controls="example" rowspan="1" colspan="1"  style="width: 229px;">Category Name</th>
