          ...
          <div id="wrap">
              <div id="page-heading">
                  <ol class="breadcrumb">
                      ...
                      <li>Attendance Managment</li>
                      <li class="active">Manage Teacher's Attendance</li>
                  </ol>
                  <h1>Attendance Managment</h1>
                </div>
        <div class="container">
             <?php 
            if($f==1)
            ...
            <form action="" enctype="multipart/form-data" method="post" class="form-horizontal row-border" style="border-top-left-radius: 0px; border-top-right-radius: 0px; border-bottom-right-radius: 0px; border-bottom-left-radius: 0px;">
              ...
              <div class="col-md-12">
                    <div class="panel panel-sky">
                     ...
                     <h4>Teacher Attendence Details</h4>
                    </div>
                    <div class="panel-body collapse in">
                        ...
                        <label class="col-sm-3 control-label">Employee Department</label>
                            ...
                            <div id="example_wrapper" class="dataTables_wrapper" role="grid">
                                ...
                                <thead>
                                    <tr role="row">
                                        <th class="sorting" role="columnheader" tabindex="0" aria-controls="example" rowspan="1" colspan="1"  style="width: 265px;">Employee Name</th>
                                        <th class="sorting" role="columnheader" tabindex="0" aria-controls="example" rowspan="1" colspan="1"  style="width: 107px;">Attendance</th></tr>
                                </thead>
                                
                            <tbody role="alert" aria-live="polite" aria-relevant="all">
                                <tr class="gradeA odd">
                                <td class=" ">Razia Begum</td>
                                <td class=" "><input type="checkbox" name="attendence[]"></td>
                                </tr>
                               <tr class="gradeA odd">
                                <td class=" ">Fazia Nahar</td>
                                <td class=" "><input type="checkbox" name="attendence[]"></td>
                                </tr>
                                <tr class="gradeA odd">
                                <td class=" ">Ragav Shuyel</td>
                                <td class=" "><input type="checkbox" name="attendence[]"></td>
                                </tr>
                                <tr class="gradeA odd">
                                <td class=" ">Prince kumar</td>
                                <td class=" "><input type="checkbox" name="attendence[]"></td>
                                </tr>
                              <?php
