          ...
          <div id="wrap">
              <div id="page-heading">
                  <ol class="breadcrumb">
                      ...
                      <li>Book's Information</li>
                      <li class="active">Add New Book's Information</li>
                  </ol>
             ...
             <div class="panel panel-midnightblue">
                ...
                <div class="panel-body collapse in">
                    <div class="form-group">
                            <label style="" class="col-sm-3 control-label">Serial Number</label>
                            <div style="" class="col-sm-3">
                                <input type="text" name="emp_name" class="form-control">
                            </div>
                        </div>
                        <div class="form-group">
                            <label style="" class="col-sm-3 control-label">Book Title</label>
                            <div style="" class="col-sm-3">
                                <input type="text" name="emp_name" class="form-control">
                            </div>
                             <label style="" class="col-sm-3 control-label">Book Category</label>
                            <div style="" class="col-sm-3">
                                <input type="text" name="emp_name" class="form-control">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label style="" class="col-sm-3 control-label">Book Author</label>
                            <div style="" class="col-sm-3">
                                <input type="text" name="emp_name" class="form-control">
                            </div>
                             <label style="" class="col-sm-3 control-label">Book Division</label>
                            <div style="" class="col-sm-3">
                                <input type="text" name="emp_name" class="form-control">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label style="" class="col-sm-3 control-label">Book Edition</label>
                            <div style="" class="col-sm-3">
                                <input type="text" name="emp_name" class="form-control">
                            </div>
                             <label style="" class="col-sm-3 control-label">Book Year</label>
                            <div style="" class="col-sm-3">
                                <input type="text" name="emp_name" class="form-control">
                            </div>
                        </div>
            ...
            <div class="panel panel-midnightblue">
                ...
                <div class="panel-body collapse in">
                        <div class="form-group">
                            ...
                            <label style="" class="col-sm-3 control-label">Student Name</label>
                            <div style="" class="col-sm-3">
                                <input type="text" name="reg_name" id="reg_name" class="form-control" style="width: 91%;height: 0%;">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                             ...
                             <label style="" class="col-sm-3 control-label">Return Date</label>
                            <div class="col-sm-3">
                                <input type="text" class="form-control" name="emp_joindate" id="datepicker">
                            </div>
                        </div>
