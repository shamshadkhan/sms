    ...
    <div id="wrap">
        <div id="page-heading">
            <ol class="breadcrumb">
                ...
                <li>Books Managment</li>
                <li class="active">Manage Books Issue</li>
            </ol>
                    ...
                    <div class="panel panel-sky">
                        ...
                        <div class="panel-body collapse in">
                            ...
                            <div id="example_wrapper" class="dataTables_wrapper" role="grid">
                                ...
                                <thead>
                                    <tr role="row">
                                        <th class="sorting" role="columnheader" tabindex="0" aria-controls="example" rowspan="1" colspan="1"  style="width: 265px;">Books Title</th>
                                        <th class="sorting" role="columnheader" tabindex="0" aria-controls="example" rowspan="1" colspan="1"  style="width: 265px;">Author</th>
                            ...
                            <tbody role="alert" aria-live="polite" aria-relevant="all">
                                ...
                                <td class=" ">I</td>
                                <td class=" "><span class="action-icon">Collected</span>|<span class="action-icon"><a href="book_issue.php" id="issue">Issue</a></span></td>
                                </tr>
