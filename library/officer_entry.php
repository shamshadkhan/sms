      ...
      <div id="page-content" style="min-height: 883px;">
          <div id="wrap">
              <div id="page-heading">
                  <ol class="breadcrumb">
                      ...
                      <li class="active">Add New Officer Information</li>
                  </ol>
        ...
        <div class="container">
          ...
          ?>
            <form action="" enctype="multipart/form-data" method="post" class="form-horizontal row-border" style="border-top-left-radius: 0px; border-top-right-radius: 0px; border-bottom-right-radius: 0px; border-bottom-left-radius: 0px;">
             <div class="panel panel-midnightblue">
                <div class="panel-heading">
                    <h4>Officer's General Details</h4>
                </div>
                <div class="panel-body collapse in">
                    <div class="form-group">
                            <label style="" class="col-sm-3 control-label">Officer Number</label>
            ...
            <div class="panel panel-midnightblue">
                <div class="panel-heading">
                    <h4>Officer's Personal Details</h4>
                </div>
                <div class="panel-body collapse in">
                        <div class="form-group">
            ...
            <div class="panel panel-midnightblue">
                <div class="panel-heading">
                    <h4>Officer's Contact Details</h4>
                </div>
                <div class="panel-body collapse in">
                        <div class="form-group">
