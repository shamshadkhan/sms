          ...
          <div id="wrap">
              <div id="page-heading">
                  <ol class="breadcrumb">
                      ...
                      <li>Registeration Managment</li>
                      <li class="active">Manage Student's Registeration</li>
                  </ol>
                  <h1>Registeration Managment</h1>
                </div>
        <div class="container">
             <?php 
            if($f==1)
            ...
            <form action="" enctype="multipart/form-data" method="post" class="form-horizontal row-border" style="border-top-left-radius: 0px; border-top-right-radius: 0px; border-bottom-right-radius: 0px; border-bottom-left-radius: 0px;">
              ...
              <div class="col-md-12">
                    <div class="panel panel-sky">
                     ...
                     <h4>Student Registeration Details</h4>
                    </div>
                    <div class="panel-body collapse in">
                        ...
                        <div class="form-group">
                            ...
                            <div id="example_wrapper" class="dataTables_wrapper" role="grid">
                                ...
                                <thead>
                                    <tr role="row">
                                        <th class="sorting" role="columnheader" tabindex="0" aria-controls="example" rowspan="1" colspan="1"  style="width: 265px;">Student Name</th>
                                        <th class="sorting" role="columnheader" tabindex="0" aria-controls="example" rowspan="1" colspan="1"  style="width: 107px;">Register</th></tr>
                                </thead>
