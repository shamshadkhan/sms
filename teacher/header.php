<header class="navbar navbar-inverse navbar-fixed-top" role="banner">
        ...
        <ul class="nav navbar-nav pull-right toolbar">
          <li class="dropdown">
            <a href="" class="dropdown-toggle username" data-toggle="dropdown"><span class="hidden-xs"><?php echo !empty($_SESSION['name'])? $_SESSION['name']: "";?>
            ...
            <ul class="dropdown-menu userinfo arrow">
              <li class="username">
                  <a href="">
                    ...
                    <div class="pull-right"><h5>Hello, Teacher!</h5>
                      <small>Logged in as <span>Teacher</span></small></div>
                  </a>
              </li>
              <li class="userlinks">
